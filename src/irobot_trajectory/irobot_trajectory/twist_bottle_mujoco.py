...
class TrajectoryPlannerNode(Node):
    ...
    def precompute_multi_stage_trajectory(self):
        ...
        waypoints = [
            ...
            {
                "right_pose": (np.array([0.407, -0.120, 1.0531]), np.array([0.000, -0.000, 0.000, 1.000])),
                "left_pose":  (np.array([0.382, 0.33394, 1.2435]), np.array([0.3429, -0.000, 0.000, 0.93937])),
                "duration": 3.0,
            },#右臂至抓取点等待抓取，左臂等待
            {
            ...
            # },#水杯移至接水点，
            {
                ...
                "left_pose":  (np.array([0.327, -0.02, 1.2731]), np.array([0.6000, -0.3760, -0.5986, 0.3746])),
                "duration": 3.0,  
            },#水瓶倾斜，左臂至拧瓶盖准备姿态
            {
                "right_pose": (np.array([0.327, -0.140, 1.165]), np.array([-0.531, -0.001, -0.001, 0.848])),
                "left_pose":  (np.array([0.327, -0.02, 1.2731]), np.array([-0.3746, 0.5986, -0.3760, 0.6000])),
                "duration": 4.0,  
            },#水瓶倾斜，左臂旋转180度
            {
                "right_pose": (np.array([0.327, -0.140, 1.165]), np.array([-0.531, -0.001, -0.001, 0.848])),
            ...
            {
                "right_pose": (np.array([0.327, -0.140, 1.165]), np.array([-0.531, -0.001, -0.001, 0.848])),
                "left_pose":  (np.array([0.327, 0.05, 1.2931]), np.array([0.6000, -0.3760, -0.5986, 0.3746])),
                "duration": 4.0,
            },#水瓶倾斜，左臂拿着瓶盖远离
            ...
            {
                "right_pose": (np.array([0.357, -0.050, 1.3531]), np.array([0.000, -0.000, 0.000, 1.000])),
                "left_pose":  (np.array([0.357, 0.100, 1.1531]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 5.0  
            },#水杯移至接水点
            {
                "right_pose": (np.array([0.357, -0.050, 1.3031]), np.array([-0.531, -0.001, -0.001, 0.848])),
                "left_pose":  (np.array([0.357, 0.100, 1.1531]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 3.0  
            },#开始倒水
            {
