...
class TrajectoryPlannerNode(Node):
    ...
    def precompute_multi_stage_trajectory(self):
        ...
        waypoints = [
            ...
            {
                "right_pose": (np.array([0.400, -0.150, 1.0331]), np.array([0.000, -0.000, 0.000, 1.000])),
                "left_pose":  (np.array([0.400, 0.190, 1.0331]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 2.0  
            },#等待抓取完成
            {
                "right_pose": (np.array([0.350, -0.0, 1.2531]), np.array([0.000, -0.000, 0.000, 1.000])),
                "left_pose":  (np.array([0.350, 0.190, 1.2331]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 5.0  
            },#右手方块移至中间方块上方，左手拿起方块等待
            {
                "right_pose": (np.array([0.350, -0.0, 1.1031]), np.array([0.000, -0.000, 0.000, 1.000])),
                "left_pose":  (np.array([0.350, 0.190, 1.2331]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 5.0  
            },#右手方块下降，左手等待
            {
            ...
            {
                "right_pose": (np.array([0.350, -0.0, 1.231]), np.array([0.000, -0.000, 0.000, 1.000])),
                "left_pose":  (np.array([0.350, 0.190, 1.2331]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 3.0,
            },#右手回到上方，左手等待
            {
            ...
            {
                "right_pose": (np.array([0.382, -0.33394, 1.2435]), np.array([-0.3429, -0.000, 0.000, 0.93937])),
                "left_pose":  (np.array([0.350, 0.0, 1.15331]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 3.0,
            },#左手开始放置
            {
                "right_pose": (np.array([0.382, -0.33394, 1.2435]), np.array([-0.3429, -0.000, 0.000, 0.93937])),
                "left_pose":  (np.array([0.355, 0.0, 1.15331]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 3.0,
                "action": [
                    # {"gripper": "right", "command": "open"},
