...
class TrajectoryPlannerNode(Node):
    ...
    def precompute_multi_stage_trajectory(self):
        ...
        waypoints = [
            # {
            #     "right_pose": (np.array([0.382, -0.300, 1.1831]), np.array([0.000, -0.000, 0.000, 1.000])),
            #     "left_pose":  (np.array([0.382, 0.300, 1.1831]), np.array([0.000, -0.000, 0.000, 1.000])),
            #     "duration": 4.0  
            # },#移开
            # {
            #     "right_pose": (np.array([0.407, -0.300, 1.2731]), np.array([0.000, -0.000, 0.000, 1.000])),
            #     "left_pose":  (np.array([0.397, 0.300, 1.2731]), np.array([0.000, -0.000, 0.000, 1.000])),
            #     "duration": 5.0  
            # },#至上方上方抓取
            {
                "right_pose": (np.array([0.407, -0.120, 1.2731]), np.array([0.000, -0.000, 0.000, 1.000])),
                "left_pose":  (np.array([0.397, 0.150, 1.2731]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 3.0  
            },#至抓取点上方
            {
                "right_pose": (np.array([0.407, -0.120, 1.0331]), np.array([0.000, -0.000, 0.000, 1.000])),
            ...
            {
                "right_pose": (np.array([0.357, -0.10, 1.3031]), np.array([0.000, -0.000, 0.000, 1.000])),
                "left_pose":  (np.array([0.357, 0.150, 1.0331]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 5.0  
            },#水瓶移至倒水点,
            {
                "right_pose": (np.array([0.357, -0.10, 1.3031]), np.array([0.000, -0.000, 0.000, 1.000])),
                "left_pose":  (np.array([0.327, 0.050, 1.1731]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 5.0  
            },#水杯移至接水点
            {
                "right_pose": (np.array([0.357, -0.10, 1.3031]), np.array([-0.7660, -0.000, -0.000, 0.6428])),
                "left_pose":  (np.array([0.327, 0.050, 1.1731]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 3.0  
            },#开始倒水
            {
            ...
            {
                "right_pose": (np.array([0.382, -0.160, 1.2431]), np.array([0.000, -0.000, 0.000, 1.000])),
                "left_pose":  (np.array([0.382, 0.160, 1.2431]), np.array([0.000, -0.000, 0.000, 1.000])),
                "duration": 3.0,
            },#上升
            {
